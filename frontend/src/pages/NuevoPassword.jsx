...
const NuevoPassword = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (password.length < 6 ){
            setAlerta({
                msg: 'El password nuevo es muy corto (mínimo 6 caracteres)',
                error: true
            })
            return
        }
  ...
  return (
    <>
        <h1 className="text-sky-600 font-black text-6xl capitalize">Reestablece tu password al administrador de <span className="text-slate-700">proyectos</span></h1>
